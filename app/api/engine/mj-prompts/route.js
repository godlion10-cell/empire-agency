 ...
 * LLM Í∏∞Î∞ò ?ôÏ†Å Midjourney ?ÑÎ°¨?ÑÌä∏ 4Ï¢??ùÏÑ±
 * 
...
- Keyword "ÏπòÌÇ®Ïß? ??prompts about fried chicken restaurant, crispy golden chicken, cozy Korean restaurant atmosphere
- Keyword "?ºÌä∏?àÏä§" ??prompts about gym, fitness lifestyle, athletic bodies, workout equipment
- Keyword "Ïπ¥Ìéò" ??prompts about coffee shop, barista, latte art, cozy interior
- Keyword "?¨Î¶¨?? ??prompts about human psychology, brain visualization, emotional portraits
...
Remember: Match the prompts to what "${keyword}" ACTUALLY means. Do NOT default to apartments or real estate.`;
    ...
    // ?ê‚ïê??QA Gate 2: Visual Prompt Validation ?ê‚ïê??    const qaCheck = evaluateVisualPrompts(prompts);
    console.log(`?õ°Ô∏?[MJ-QA] ${qaCheck.pass ? '??PASS' : '?†Ô∏è ISSUES: ' + qaCheck.issues.join(', ')}`);
